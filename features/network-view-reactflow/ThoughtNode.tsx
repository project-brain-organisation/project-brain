// DRAFT (React Flow, maximally OOTB) — final: apps/web/src/components/ThoughtNode.tsx
//
...
export const ThoughtNode = memo(({ data }: NodeProps<ThoughtFlowNode>) => {
  ...
  return (
    <div className={`tnode${isRoot ? ' tnode--root' : ''}`}>
      ...
      {/* Full title — CSS (.tnode-label) clamps it to two lines with an ellipsis.
          The node owns *display*; graphModel only estimates footprint for layout. */}

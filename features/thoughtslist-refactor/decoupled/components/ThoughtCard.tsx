// Destination: apps/web/src/components/ThoughtCard.tsx  (connected — 2 props)
    ...
    return combine(
      draggable({
        ...
        getInitialData: (): DragData => {
          const s = live.current;
          return { type: 'thought', id: s.thought.id, blocked: selfAndDescendants(s.allThoughts, s.thought.id) };
        },
      }),
